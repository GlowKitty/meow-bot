...
java -cp .:lib/pircbot.jar:lib/commons-logging-1.2.jar:lib/commons-beanutils-1.9.2.jar:lib/commons-digester-2.1.jar:lib/commons-digester-rss.jar org.meowbot.MeowBotMain
echo ">>>End"